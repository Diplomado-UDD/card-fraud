...
def __():
    ...
    return mo, np, pd, plt, sns, Path, warnings
...
def __(df, mo):
    ...
    return missing_values, total_missing
...
def __(df, mo, np):
    ...
    return class_counts, fraud_percentage, imbalance_ratio


@app.cell
def __(class_counts, plt):
...
def __(df, mo):
    ...
    return amount_stats, time_stats
...
def __(df, mo, np):
    ...
    return fraud_amount_stats, legit_amount_stats
...
def __(df, plt, sns):
    ...
    plt.tight_layout()
    plt.gca()
    return axes_v, feature, fig_v, idx, sample_v_features
...
@app.cell
def __(correlation_with_class, mo):
...
@app.cell
def __(correlation_with_class, plt):
    ...
    plt.tight_layout()
    plt.gca()
    return ax_corr, fig_corr


@app.cell
def __(df, mo, np, pd, plt, sns, v_columns):
